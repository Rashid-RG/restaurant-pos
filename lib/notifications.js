...
// Custom DNS lookup that explicitly forces family 4 (IPv4) resolution
  ...
  for (const config of uniqueAttempts) {
    try {
      ...
      const transporter = nodemailer.createTransport({
        ...
        family: 4,
        lookup: lookupIPv4, // Force IPv4 resolution directly at DNS layer to fix Render IPv6 ENETUNREACH
        auth: { user, pass },
